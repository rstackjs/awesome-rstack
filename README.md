...
- [rspress-plugins-auto-meta](https://github.com/smileluck/rspress-plugins-auto-meta.git): Rspress plugin to automatically generate navigation metadata for your documentation.
